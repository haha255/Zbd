...
from . import views_user, views_structure, views_menu, views_role
...
urlpatterns = [
    ...
    path('rbac/role/role2menulist/', views_role.Role2MenuListView.as_view(), name='rbac-role-role2menu_list'),
