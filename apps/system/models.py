...
class Structure(models.Model):
    ...
    组织架构
    """
    type_choices = (("unit", "单位"), ("dept", "部门"))
    name = models.CharField(max_length=60, verbose_name="名称")
    type = models.CharField(max_length=20, choices=type_choices, default="dept", verbose_name="类型")
...
class UserProfile(AbstractUser):
    ...
    tel = models.CharField(max_length=11, default='', verbose_name="座机")
